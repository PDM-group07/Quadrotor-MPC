...
class BenchmarkEnv(gym.Env):
    ...
    def __init__(self,
        ...
        self.COST = Cost(cost)
        #Create action and observation spaces.     coMMENTED EVERYTHING UNDER THIS
    ...
    def _set_action_space(self):
        ...
        self.action_space = spaces.Dict({str(i): spaces.Box(low=act_lower_bound,
                                               high=act_upper_bound,
                                               dtype=np.float32
                                               ) for i in range(self.NUM_DRONES)} )["0"]
    ...
    def _set_observation_space(self):
        ...
        self.observation_space  = spaces.Dict({str(i): spaces.Dict({"state": spaces.Box(low=obs_lower_bound,
                                                                     high=obs_upper_bound,
                                                                     dtype=np.float32
                                                                     ),
                                                 "neighbors": spaces.MultiBinary(self.NUM_DRONES)
                                                 }) for i in range(self.NUM_DRONES)})["0"]["state"]
